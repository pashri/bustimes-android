 ...
 */
@Composable
fun LatenessLabel(lateness: Lateness, modifier: Modifier = Modifier) {
    ...
    Text(
        ...
        color = when (lateness) {
            is Lateness.Late -> LateColour
            is Lateness.Early, Lateness.OnTime -> EarlyColour
            Lateness.Unknown -> MaterialTheme.colorScheme.onSurfaceVariant
        },
        modifier = modifier,
    )
}
